...
First you need to start a new project in a new directory inside RStudio. Choose `Quarto Website` as the project type. You can easily add a blog to your website later if you want. I'll show you in a minute.
...
This will throw you a bunch of error messages. Not to worry. This is because we forgot to commit our files. Click of the Staged tick boxes in the git pane and push `commit`. A pop-up pane will appear. Write a brief commit message and push the `Commit` button:
...
If you now visit to your github repo's website at `https://github.com/your-username/your-repo-name`, you should find all the files you committed there. From now on, you should be able to update any local changes to your GitHub-repo by committing and pushing from the Git-pane.
